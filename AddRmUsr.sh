...
if [ $1 = add ]
	sudo dscl . create /Users/logsmover
	sudo dscl . create /Users/logsmover UserShell /bin/bash
	sudo dscl . create /Users/logsmover RealName "Logs Mover"
	sudo dscl . create /Users/logsmover UniqueID 666
	sudo dscl . create /Users/logsmover PrimaryGroupID 1000
	sudo dscl . create /Users/logsmover NFSHomeDirectory /Local/Users/corybohon
	sudo dscl . passwd /Users/logsmover logsmover
	sudo dscl . append /Groups/admin GroupMembership logsmover
fi
